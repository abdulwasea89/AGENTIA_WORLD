...
const SignInPage = () => {
    ...
    return (
        <div className="flex flex-col lg:flex-row min-h-screen text-foreground">
            <div className="flex-1 p-4 sm:p-8 lg:p-12 flex flex-col justify-center">
                <div className="max-w-md mx-auto w-full space-y-6 sm:space-y-8">
                    <div className="text-center lg:text-left">
                        <h1 className="text-3xl lg:text-4xl font-semibold tracking-tight text-primary">Sign In</h1>
                    ...
                    <div className="flex flex-col lg:flex-row gap-4">
                        <Button
                            variant="outline"
                            className="w-full justify-center gap-3 py-3 lg:py-4 border-primary hover:bg-primary/5 transition-all"
                        >
                    ...
                    <div className="my-4 flex items-center gap-2 sm:gap-4">
                        ...
                        <p className="text-sm text-muted-foreground text-nowrap">OR</p>
                        <hr className="w-full border-border" />
                    </div>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                autoCorrect="off"
                                {...register("email")}
                                className="bg-secondary text-secondary-foreground h-10 sm:h-11"
                            />
                            {errors.email && (
