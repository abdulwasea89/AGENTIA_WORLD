...
const SignUpPage = () => {
    ...
    const handleSignUp = async (data: SignUpFormData) => {
        ...
        try {
            ...
            // For demonstration, we'll just simulate a delay and then redirect
            await new Promise((resolve) => setTimeout(resolve, 1500))

            // If sign up is successful, you might want to log the user in automatically
        ...
        <div className="flex flex-col lg:flex-row min-h-screen text-foreground">
            <div className="flex-1 p-8 lg:p-12 flex flex-col justify-center">
                <div className="max-w-md mx-auto w-full space-y-8">
                    ...
                    <div className="my-4 flex items-center gap-4"> <hr className="w-full border-gray-300" /> <p className="text-sm text-white text-center">OR </p> <hr className="w-full border-gray-300" /> </div>
                    ...
                    <form onSubmit={signUpForm.handleSubmit(handleSignUp)} className="space-y-6">
                        ...
                        <Button
                            ...
                            disabled={isLoading}
                        >
                            {isLoading ? <LoaderIcon className="w-4 h-4 animate-spin" /> : "Sign Up"}
                        </Button>
                    </form>
