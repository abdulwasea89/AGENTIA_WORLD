                ...
                <div className="flex flex-col items-start gap-10 py-8 w-full">
                    <div className="flex flex-col items-start gap-4">
                        <AnimationContainer animation="fadeUp" delay={0.2}>
                            <SectionBadge title=" AI-Powered Innovation" />
                        </AnimationContainer>
                        ...
                        <AnimationContainer animation="fadeUp" delay={0.4}>
                            <h1 className="text-5xl lg:text-6xl font-medium !leading-tight text-transparent bg-clip-text bg-gradient-to-r from-foreground to-neutral-500">
                                Empowering Agents – Discover, Buy & Build the Future.
                            </h1>
                        </AnimationContainer>

                        <AnimationContainer animation="fadeUp" delay={0.6}>
                            <p className="text-sm md:text-base lg:text-lg text-muted-foreground">
                                Unlock the power of Agentia – where developers create cutting-edge AI agents, and buyers harness their potential to shape the future
                            </p>
                        </AnimationContainer>
                    </div>
