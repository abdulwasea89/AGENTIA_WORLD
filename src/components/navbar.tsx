                ...
                <Wrapper className="flex items-center justify-between lg:px-4">
                    ...
                    >
                        <Link href="/" className="flex items-center gap-2">
                               <span className="font-bold text-md w-max h-6 -mt-1 bg-gradient-to-r from-white to-gray-500 text-transparent bg-clip-text font-sans">
        AGENTIA WORLD
      </span>
                        </Link>
                    </motion.div>
                            ...
                            {NAV_LINKS.map((link, index) => (
                                ...
                                >
                                    <div className="relative">
                                        <Link href={link.link} className="hover:text-foreground transition-all duration-500  rounded-md px-4 py-2">
                                            {link.name}
                                        </Link>
                                    </div>
                                </AnimationContainer>
