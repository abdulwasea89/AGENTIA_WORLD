        ...
        <Wrapper className="py-20 lg:py-32">
            <div className="flex flex-col items-center text-center gap-4 mb-16">
                <AnimationContainer animation="fadeUp" delay={0.2}>
                    <SectionBadge title="Featured Agents
" />
                </AnimationContainer>
                ...
                <AnimationContainer animation="fadeUp" delay={0.4}>
                    <p className="text-sm md:text-base lg:text-lg text-muted-foreground max-w-2xl mx-auto">Discover top-rated AI agents selected for their exceptional quality and performance. Perfect for developers looking to showcase their work or buyers seeking reliable solutions. Explore the best our marketplace has to offer.
                    </p>
                </AnimationContainer>
            </div>
